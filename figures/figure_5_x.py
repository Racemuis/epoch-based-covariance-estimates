...
def plot_benchmark_results(results, dataset=None, dim_prefix='', jm_dim=None, ylim=None, save=False, output_dir=None,
    ...
    if plot_legend:
        ...
        # Create another legend - if you have got few participants, set ncol = 1, else 2. 
        plt.legend(handles=leg_handles, labels=leg_labels, title='Subj.', ncol=2, prop={'size': 8},
...
def plot_matched_wrapper(data=None, x=None, y=None, x_order=None, match_col=None, x_match_sort=None, title=None,
                         ax=None, figsize=(9, 6)):
    if ax is None:
        fig, ax = plt.subplots(1, 1, facecolor='white', figsize=figsize, dpi = 200)
